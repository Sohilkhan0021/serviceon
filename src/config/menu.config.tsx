...
import { ADMIN_MENU_SIDEBAR, ADMIN_MENU_ROOT } from './admin-menu.config';
    ...
    children: [
      {
        title: 'Admin Dashboard',
        children: [
          { title: 'Dashboard', icon: 'element-11', path: '/admin' },
          { title: 'Garages', icon: 'garage', path: '/admin/garages' },
          { title: 'Add Garage', icon: 'plus', path: '/admin/garages/create' },
          { title: 'Branding', icon: 'paint-bucket', path: '/admin/branding' },
          { title: 'Checklist', icon: 'check-square', path: '/admin/checklist' },
          { title: 'Labor Rates', icon: 'dollar', path: '/admin/labor-rates' },
          { title: 'Users', icon: 'users', path: '/admin/users' },
          { title: 'Add User', icon: 'user-plus', path: '/admin/users/create' },
...
// Export admin menu configurations
export { ADMIN_MENU_SIDEBAR, ADMIN_MENU_ROOT };
